...
namespace Microsoft.CST.OAT {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Rule {0} Clause {1} is missing required Script Data for Script operation..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Failed to load the OAT.Scripting assembly to enable scripting..
        /// </summary>
        internal static string Err_ErrorLoadingScriptingAssembly {
            get {
                return ResourceManager.GetString("Err_ErrorLoadingScriptingAssembly", resourceCulture);
            }
        }
        ...
        internal static string Err_ExceptionLoadingScriptingAssembly__0_ {
            get {
                return ResourceManager.GetString("Err_ExceptionLoadingScriptingAssembly_{0}", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Rule {0}, Clause {1} is invalid as the Operator is set to NoOperation..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Rule {0} Clause {1} has Script but RunScripts is false..
        /// </summary>
